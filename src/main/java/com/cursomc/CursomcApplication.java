...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Estado est1 = new Estado(null, "Minas Geras");
		...
		cli1.getTelefones().addAll(Arrays.asList("21542589", "945876321"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "02145620", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "12485420", cli1, c2);
